...
function GameDateInput({
  ...
  return (
    <input
      ...
      className="w-28 rounded-lg border border-slate-300 bg-white px-2 py-1 text-xs font-bold outline-none focus:border-slate-950 focus:ring-2 focus:ring-slate-200"
...
export default function App() {
  ...
  const [lastImpact, setLastImpact] = useState<
    { title: string; scores: string[]; messages: string[] } | null
  >(null);
        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-5 px-4 py-5 sm:px-6 lg:px-8">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <div className="mt-2 inline-flex rounded-full bg-slate-100 px-3 py-1 text-xs font-black uppercase tracking-wide text-slate-600">
          ...
          <div
            ...
            className="flex gap-2 rounded-2xl bg-slate-100 p-1 w-fit"
          >
            {VIEW_ORDER.map((view) => (
              <button
                key={view}
      ...
      >
        {teams.length === 0 ? (
          ...
          <ModelView
            ...
            controlLevelForTeam={controlLevelForTeam}
...
function StandingsView({
  ...
  lastImpact: { title: string; scores: string[]; messages: string[] } | null;
  dismissImpact: () => void;
          ...
          <div className="border-b border-slate-200 bg-blue-50 px-5 py-4">
              ...
              <div className="mb-3 rounded-2xl bg-white p-3 shadow-sm ring-1 ring-blue-100">
                ...
                <div className="flex flex-wrap gap-2 text-xs font-black text-slate-800">
                  {lastImpact.scores.map((score) => (
                    <span key={score} className="rounded-full bg-slate-100 px-3 py-1">
                      {score}
                    </span>
                  ))}
                </div>
            ...
            <div className="flex flex-wrap gap-2 text-xs font-black text-blue-700">
              {lastImpact.messages.map((change) => (
                <span
                  key={change}
                  className="rounded-full bg-white px-3 py-1 shadow-sm ring-1 ring-blue-100"
                >
                  {change}
                </span>
              ))}
                    ...
                    <React.Fragment key={team.id}>
                      {index === goldCutoff && (
                        ...
                        >
                          <td
                            colSpan={8}
                            className="bg-slate-950 px-5 py-2 text-center text-xs font-black uppercase tracking-[0.22em] text-red-400"
                          >
                            Gold Cut Line
                          </td>
                        </tr>
                      ...
                      <tr
                        ...
                        className="cursor-pointer hover:bg-slate-50/70 focus:bg-slate-100 focus:outline-none"
                      >
                        <td className="px-5 py-4 font-black text-slate-500">#{team.rank}</td>
              ...
              return (
                <div
                  ...
                  className={`rounded-2xl border p-4 ${
                    inside ? "border-emerald-200 bg-emerald-50/60" : "border-slate-200 bg-white"
                  }`}
                >
                  <div className="flex items-center justify-between gap-3">
                    <div>
...
function ModelView(props: {
  ...
  controlLevelForTeam: (t: TeamWithProjection) => string;
  ...
  return (
    <section className="space-y-6">
      ...
      <section className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
        ...
        {modelRows.length === 0 ? (
          <div className="p-8 text-center text-sm font-bold text-slate-500">No teams yet.</div>
        ) : (
          <div className="overflow-x-auto">
        ...
        <div className="grid grid-cols-1 gap-3 md:grid-cols-[140px_1fr_1fr_auto]">
          ...
          <label htmlFor={awayId} className="block">
            ...
            <select
              ...
              className="w-full rounded-xl border border-slate-300 px-3 py-2 font-bold outline-none focus:border-slate-950"
            >
      ...
      <div className={`${card} p-4`}>
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          ...
          <select
            ...
            className="rounded-xl border border-slate-300 px-3 py-2 text-sm font-bold outline-none focus:border-slate-950 md:w-72"
          >
            ...
            return (
              <article
                ...
                className={`overflow-hidden rounded-3xl border bg-white shadow-sm ${
                  final ? "border-slate-200 opacity-80" : "border-slate-200"
                }`}
              >
                <div className="flex items-center justify-between border-b border-slate-200 bg-slate-50 px-4 py-3">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="rounded-lg border border-slate-300 bg-white px-3 py-1 text-xs font-black text-red-600"
                  ...
                  <div className="flex items-center justify-between border-t border-slate-100 pt-3 text-sm font-bold text-slate-500">
                    <label className="flex items-center gap-2">
                      ...
                      <input
                        ...
                        className="w-14 rounded-lg border border-slate-300 px-2 py-1 text-center font-black text-slate-950"
                      />
                    </label>
                    <span>
                      {final
