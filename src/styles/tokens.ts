...
export const card =
  "rounded-2xl border border-slate-200 bg-white shadow-sm shadow-slate-200/70 ring-1 ring-white/70 dark:border-slate-800 dark:bg-slate-950 dark:shadow-black/20 dark:ring-slate-900";
